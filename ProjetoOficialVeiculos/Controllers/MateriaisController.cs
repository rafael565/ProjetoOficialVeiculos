...
namespace ProjetoOficialVeiculos.Controllers
{
    ...
    public class MateriaisController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,nome,quantidade")] Material material)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,nome,quantidade")] Material material)
        {
            if (id != material.id)
            {
                return NotFound();
